...
export default function LearningPathRoadmap({
  ...
  // Prevent blinking by ensuring component is mounted
  useEffect(() => {
    setMounted(true);
  }, []);
  ...
  const renderModule = (module: Module, index: number) => {
    ...
    const moduleKey = module._id || module.id || `${index}`;

    return (
      <div key={moduleKey} className="relative pl-16 pb-8">
        {/* Timeline Node */}
        <div
          className={cn(
    ...
    return (
      <div className="space-y-6">
        <div className="relative">
          {/* Loading skeleton to prevent blinking */}
